...
## Obtain AZURE Variables by pepesan
az login
az account show
az ad sp create-for-rbac --name "myproject" --role="Contributor" --scopes="/subscriptions/[subscription_id]" -o table

| AppId   |      DisplayName      |  Name | Password |Tenant |
|----------|:-------------:|------:|------:|------:|
| [AZURE_CLIENT_ID]   |  myproject | http://myproject |[AZURE_CLIENT_SECRET]   | [TENANT_ID] |
